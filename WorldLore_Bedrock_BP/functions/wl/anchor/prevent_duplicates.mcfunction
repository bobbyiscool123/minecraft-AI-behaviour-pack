# Keep one primary per local place radius
execute as @e[type=villager,tag=wl_anchor_primary] at @s run tag @e[type=villager,tag=wl_anchor_primary,r=20,rm=1] add wl_anchor_duplicate
